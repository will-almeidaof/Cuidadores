...
class Usuario(Base):
    ...
    # passive_deletes=True: deixa o CASCADE do banco resolver, sem o SQLAlchemy
    # tentar zerar a FK antes de deletar
...
class Cuidador(Base):
    ...
    telefones   = relationship("TelefoneCuidador", back_populates="cuidador",
...
class TelefoneCuidador(Base):
    ...
    id_usuario = Column(Integer, ForeignKey("cuidador.id_usuario", ondelete="CASCADE"),
                        nullable=False)
...
class Paciente(Base):
    ...
    historicos  = relationship("HistoricoMedico", back_populates="paciente",
                               cascade="all, delete-orphan", passive_deletes=True)
